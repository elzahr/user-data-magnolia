package guillermo.magnolia;

import info.magnolia.module.ModuleLifecycle;
import info.magnolia.module.ModuleLifecycleContext;
import info.magnolia.module.blossom.module.BlossomModuleSupport;
import guillermo.magnolia.config.ChallengeModuleConfiguration;
import guillermo.magnolia.config.BlossomServletConfiguration;

/**
 * This class manages the lifecycle of the challenge-module module. It starts and stops Spring when Magnolia starts up and
